      ...
      <div className="fixed top-14 right-4 z-50">
        {menuOpen && (
          <div className="absolute top-16 right-0 w-48 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mt-2">
            ...
            </button><button onClick={() => { setShowHelp(true); setMenuOpen(false); }} className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 border-b border-gray-50">❓ 도움말</button>
