    ...
    <div className="min-h-screen bg-gray-50 flex flex-col relative">
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div
          ...
          style={{ width: `${sphereSize * 0.8}px`, height: `${sphereSize * 0.15}px`, marginBottom: '-20px', zIndex: 0 }}
        />
        ...
        >
          ...
          <div
            className="absolute rounded-full bg-white/30 blur-sm"
            style={{ width: `${sphereSize * 0.25}px`, height: `${sphereSize * 0.15}px`, top: `${sphereSize * 0.12}px`, left: `${sphereSize * 0.2}px` }}
          />
        </div>
